...
public class BooleanMapJsonTypeProcessor extends AbstractMapJsonTypeProcessor {
	...
	@Override
	public void processValuesToJsonObject(List<?> values, JsonObject jo, String jsonPropertyName)
